...
<body>
    ...
    <div id="content-wrapper">
          <div class="text-center">
            ...
            <p class="lead text-gray-800 mb-5">No Internet network</p>
            <p class="text-gray-500 mb-0">It looks like you found a glitch in the matrix. Please check your Internet.</p>
