...
<body>
    ...
    <div id="content-wrapper">
          <div class="text-center">
            ...
            <p class="lead text-gray-800 mb-5">Invalid credentials in API</p>
            <p class="text-gray-500 mb-0">It looks like you found a glitch in the matrix. Please check API username and password.</p>
            <a href="<?php echo site_url('welcome/login');?>">&larr; Back to Dashboard</a>
          </div>
    </div>
