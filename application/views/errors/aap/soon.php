...
<body>
    ...
    <div id="content-wrapper">
          <div class="text-center">
            ...
            <p class="lead text-gray-800 mb-5">Page Not Found.</p><br>
            <p class="text-gray-500 mb-0">This page is under construction.</p>
            <a href="<?php echo site_url('welcome/login');?>">&larr; Back to login page.</a>
          </div>
    </div>
