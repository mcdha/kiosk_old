    ...
    $("#mem").change(function () {
        ...
        if (val === "REGULAR") {
            $("#plantype").html('<option value="">Please select plan type.</option>\n\
                                <option value="1">1 - YEAR REGULAR MEMBERSHIP (<span>&#8369;</span> 2,464)</option>\n\
                                <option value="5">3 - YEAR REGULAR MEMBERSHIP (<span>&#8369;</span> 5,824)</option>');
								$("div#second").show();
        }else if (val === "ASSOCIATE") {
            $("#plantype").html('<option value="">Please select plan type.</option>\n\
                                <option value="4">1 - YEAR ASSOCIATE MEMBERSHIP (<span>&#8369;</span> 1,904)</option>\n\
                                <option value="7">3 - YEAR ASSOCIATE MEMBERSHIP (<span>&#8369;</span> 4,424)</option>');
								$("div#second").hide();
        }else if (val === "LITE"){
 ...
 <div class="container">
    <div class="col-xl-12 col-lg-8">
        ...
        <div class="card shadow mb-4">
            ...
            <!-- Card Body -->
            <div class="card-body">
            <h2>NEW MEMBERSHIP APPLICATION FORM</h2>
                ...
                <?php echo form_open('kiosk/add','id="regForm"'); ?>
                  ...
                  <fieldset>
                    ...
                    <br>
                        <legend>Step 1 of 4 (Personal Information)</legend><br>
                        <fieldset>
                            ...
                            <div class="container-fluid">
                                <div class="row">
                                    ...
                                    <div id="foreign">   
                                        <div class="field-wrapper">
                                                <input type="text" id="nationality" name="nationality" onchange="document.getElementById('nationality1').innerHTML = this.value">
                                                <div class="field-placeholder"><span>Nationality</span></div>
                                        </div>                                    
                                        <div class="field-wrapper">
                                                <input type="text" id="acr" name="acr" onchange="document.getElementById('acr1').innerHTML = this.value">
					...
					<nav>
                        ...
                        <legend>Step 3 of 4 (Vehicle Details)</legend>
                        <fieldset>
                            <div class="container-fluid">
                                <div class="row">
                                    <div class="col-lg-6">
                                    ...
                                    <div class="col-lg-6" id="second">
                                        ...
                                        <input type="text" name="status" id="status" value="NEW" hidden>
                                        <input type="text" name="types" id="types" value="PIDP" hidden>
                                    </div>
                                </div>
                            </div>
                        </fieldset>
					...
					<nav>
                        ...
                        <h4 align="left">Step 5 of 5 (Check your information)</h4>
                        <fieldset>
                            <div class="container-fluid">
                                    <?php
...
<script>
    var v = jQuery("#regForm").validate({
     ...
     messages: {
        mem:{
            required : "Please select type of membership."
        },
		plantype:{
