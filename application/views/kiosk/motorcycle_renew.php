...
<div class="container">
    <div class="col-xl-12 col-lg-8">
        ...
        <div class="card shadow mb-4">
            ...
            <!-- Card Body -->
            <div class="card-body">
            <h2>Motorcycle Membership Renewal Form</h2><br>
            <img src="<?php echo base_url(); ?>assets/img/spinner.gif" alt="" id="loader" style="display: none" class="center">
                ...
                <div class="tab" id="form2">
                        <legend>Step 2 of 3 (Others Insured or Beneficiaries)</legend>
                        <fieldset>
                            <div class="container-fluid">
                                <div class="row">
                                    <div class="col-lg-6">
										<div class="field-wrapper hasValue1">
                                            ...
                                            <div class="field-placeholder"><span>Insured or Beneficiaries</span></div>
                                        </div>
										<div class="field-wrapper">
             ...
             <?php
			   ...
			   ?>
                    <div class="tab" id="form3">
                        <fieldset>
                            <legend>Step 3 of 3 (Personal Information)</legend>
                            <div class="container-fluid">
                                   <?php
