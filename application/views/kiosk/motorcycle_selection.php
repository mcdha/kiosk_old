        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
				...
				<div class="row justify-content-md-center">
                    <div class="col-lg-6">
						  <center>
						  <a href="<?php echo site_url('kiosk/motorcycle_new') ?>" class="block btn btn-warning">APPLY FOR NEW MOTORCYCLE MEMBERSHIP</a>
						  </center>
        
					</div>
					<div class="col-lg-6">
						  <center>
						  <a href="<?php echo site_url('kiosk/motorcycle_search') ?>" class="block btn btn-warning">RENEW MOTORCYCLE MEMBERSHIP</a>
						  </center>
