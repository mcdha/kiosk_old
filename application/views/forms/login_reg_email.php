    ...
    <div class="row justify-content-center">
      ...
      <div class="col-xl-10 col-lg-12 col-md-9">
                        ...
                        <div class="row">
                                    <div class="col-lg">
                                        <div class="field-wrapper hasValue">
                                            <input type="email" class="input" placeholder="Email Address" name="email"  id = "email" value="<?php echo isset($_POST["email"]) ? $_POST["email"] : ''; ?>"required>
        ...
        <?php echo form_close(); ?>
            <hr>
                  <div class="text-center">
                      <a class="small" href="<?php echo site_url('welcome/registration_mobile');?>">Sign up via Mobile Number</a>
                  </div>
                  <div class="text-center">
