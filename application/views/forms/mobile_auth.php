        ...
        <div class="card shadow mb-4">
                ...
                <div class="card-body">
		  		...
		  		echo $message_display;
                        ...
                        <span class="success">
                            <p> Your One-Time Password (OTP) has been sent to your mobile number <b>
                                <?php if(isset($mobile)){
                                       echo $mobile;
                        ...
                        <div style="text-align: center;">
                        <?php echo form_open('welcome/mobileauth'); ?> 
                            <div class="center-block">
                                <input type="text" class="otp-input" placeholder="Enter OTP" id="otp" name="otp" style="width:50%;" required/>
                            </div>
                            <br/>
                            <span>
                            <button id="submit" class="btn btn-success" name="button" value="1" >VERIFY OTP</button>
                            </span>
                            <span>
                            <a href="<?php echo site_url('welcome/login');?>"> <button type="button"  class="btn btn-primary">CANCEL</button> </a>
                            </span>
                            <?php echo form_close(); ?>
                            <?php echo form_open('welcome/mobileauth'); ?>
                            <br/>
                            <button class="btn btn-info" id="resend" name="button" value="2" >RESEND OTP</button>
                            <?php echo form_close(); ?>
                        </div>    
                </div>
