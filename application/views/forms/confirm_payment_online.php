...
<div class="container mt-3">
    <div class="col-xl-12 col-lg-7">
       ...
       <div class="col-lg-8">
            <?php echo form_open_multipart('online/checkout', 'id="regForm"', 'enctype="multipart/form-data"'); ?> 
            <div class="card card-cascade wider shadow p-3 mb-5 ">
                ...
                <input type="hidden" name="ref"  value="<?= $info['refnum'] ?>">
                <input type="hidden" name="payment"  value="<?= $info['payment'] ?>">
                <input type="hidden" name="amount"  value="<?= $info['amount'] ?>">
                <input type="hidden" name="email"  value="<?= $info['email'] ?>">
                <p style="text-align:center"><span> <input type="submit" id="submit" class="btn btn-primary"  value="Submit"/></span>&nbsp<span><a  class="btn btn-danger deleteRecord"  href="#" data-toggle="modal" data-target="#deleteModal" data-rec='<?= $info['refnum'] ?>'>Cancel Online Application</a></span></p>
            </div>
           <?php echo form_close() ?>
        </div>
 ...
 <!-- Delete Modal-->
  <div class="modal fade" id="deleteModal" tabindex="-1" role="dialog" aria-labelledby="deleteModalLabel" aria-hidden="true">
	...
	<?php echo form_open('online/cancelled')?>
