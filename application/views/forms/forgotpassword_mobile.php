              ...
              <div class="col-lg-6">
                <div class="p-5">
                  <div class="text-center">
                    ...
                    <p class="mb-4">We get it, stuff happens. Just enter your mobile number below and we'll send you an OTP to login to your account!</p>
                  </div>
                  
                    <span class="text-success" style="text-align: center;">
                        <?php 
                         echo form_open('welcome/mobileauth', "class='user'"); 
                    ...
                    <div class="form-group">
                        <input type="text" class="form-control form-control-user" id="exampleInputEmail" aria-describedby="emailHelp" name="mobile" placeholder="Enter Mobile Number..." required>
                    </div>
                      <button type="submit" class="btn btn-primary btn-user btn-block" >Log in using OTP</button>
                    <?php echo form_close(); ?> 
                  <hr>
                  <div class="text-center">
